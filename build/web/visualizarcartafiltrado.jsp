                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6" style="margin-top: 30px;">
                                        <input type="submit" class="btn btn-warning" value="Ejecutar"/>                                       
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-12">
                                <table class="table table-condensed" style="color: white; margin-top: 40px;">
                                    ...
                                    <tr>
                                        ...
                                        <td><%=producto.getId_categoria().getNombre()%></td>
                                        <td><a href="verdetalleproductomozo?idProducto=<%=producto.getId_producto()%>" class="form-control" style="color: #ff3333; font-weight: bold; font-size: 13px; text-align: center">Ver</a></td>
