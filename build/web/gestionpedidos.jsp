                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6" style="margin-top: 20px;">
                                        <a href="nuevopedido" style="color: #ffc831; font-size: 18px;margin-top: 20px; ">CREAR PEDIDO</a> <br>                                       
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6" style="margin-top: 20px;">
                                <a href="verliquidacion" style="color: #ffc831; font-size: 18px;margin-top: 20px; ">VER LIQUIDACIÓN DE CAJA</a> <br>                                       
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
