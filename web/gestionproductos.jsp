                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6" style="margin-top: 20px;">
                                        <a href="obtenercategorias" style="color: #ffc831; font-size: 18px;margin-top: 20px; ">CREAR PRODUCTO</a> <br>
                                        
                                    </div>
                                    <div class="col-lg-6" style="margin-top: 20px;">
                                        <a href="obtenercategorias2" style="color: #ffc831; font-size: 18px;margin-top: 20px; ">CREAR PROMOCIONES</a> <br>
