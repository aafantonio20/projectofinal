                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4"> 
                                                    ...
                                                    <input type="text" class="form-control" id="usr" name="dia" value="<%=reserva.getDia()%>">
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="usr" style="font-size: 14px; font-weight: 600; color: #e59201;">Mes:</label>
                                                    <input type="text" class="form-control" id="usr" name="mes" value="<%=reserva.getMes()%>">
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="usr" style="font-size: 14px; font-weight: 600; color: #e59201;">Año:</label>
                                                    <input type="text" class="form-control" id="usr" name="ano" value="<%=reserva.getAno()%>" disabled="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            ...
                                            <input style="width: 80px;" required id='nombres' name="hora" value="<%=reserva.getHora()%>" class="form-control">
                                        </div>
                                    </div>
