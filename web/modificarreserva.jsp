                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row">            
                                        <div class="col-md-10">                                                                                     
                                            ...
                                            <input type="number" id='telefono' name="telefono" required value="<%=cliente.getTelefono()%>" class="form-control">
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <input type="number" style="width: 80px;" required id='nombres' name="pax" value="<%=reserva.getPax()%>" class="form-control">
                                        </div>
                                        <div class="col-md-12">
